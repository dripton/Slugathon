...
class RecruitCreature(Action):
    def __init__(
        self, game_name, playername, markerid, creature_name, recruiter_names
    ):
        self.game_name = game_name
        self.playername = playername
        self.markerid = markerid
...
class Fight(Action):
    def __init__(
        self, game_name, attacker_markerid, defender_markerid, hexlabel
    ):
        self.game_name = game_name
...
class NoMoreProposals(Action):
    def __init__(
        self, game_name, playername, attacker_markerid, defender_markerid
    ):
        self.game_name = game_name
        self.playername = playername
        self.attacker_markerid = attacker_markerid
...
class MoveCreature(Action):
    def __init__(
        self, game_name, playername, creature_name, old_hexlabel, new_hexlabel
    ):
        self.game_name = game_name
        self.playername = playername
        self.creature_name = creature_name
...
class SummonAngel(Action):
    def __init__(
        self, game_name, playername, markerid, donor_markerid, creature_name
    ):
        self.game_name = game_name
        self.playername = playername
        self.markerid = markerid
...
class EliminatePlayer(Action):
    def __init__(
        self, game_name, winner_playername, loser_playername, check_for_victory
    ):
        self.game_name = game_name
