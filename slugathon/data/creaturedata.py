...
data = {
    ...
    "Behemoth": ("Behemoths", 8, 3, 0, 0, "creature", 0, 0, 18,
                 "behemoth_green"),
    "Centaur": ("Centaurs", 3, 4, 0, 0, "creature", 0, 0, 25, "centaur_gold"),
    "Colossus": ("Colossi", 10, 4, 0, 0, "creature", 0, 0, 10,
                 "colossus_pink"),
    "Cyclops": ("Cyclopes", 9, 2, 0, 0, "creature", 0, 0, 28,
                "behemoth_green"),
    ...
    "Guardian": ("Guardians", 12, 2, 0, 1, "demilord", 0, 0, 6,
                 "colossus_pink"),
