    ...
    def __init__(self, battlemap, game=None, user=None, username=None,
      scale=None):
        ...
        if game:
            ...
            spacer8 = self.spacer()
            spacer9 = self.spacer()
            spacer10 = self.spacer()
            spacer11 = self.spacer()
            spacer12 = self.spacer()
            spacer13 = self.spacer()
            ...
            self.hbox0.pack_start(spacer1)
            self.hbox0.pack_start(own_hex_label)
            self.hbox0.pack_start(spacer2)
            self.hbox0.pack_start(spacer3)
            self.hbox0.pack_start(spacer4)
            self.hbox0.pack_start(spacer5)
            self.hbox1.pack_start(spacer6)
            self.hbox1.pack_start(spacer7)
            self.hbox1.pack_start(spacer8)
            self.hbox1.pack_start(top_hex_label, expand=False)
            self.hbox1.pack_start(spacer9)
            self.hbox1.pack_start(spacer10)
            self.hbox3.pack_start(spacer11)
            self.hbox3.pack_start(spacer12)
            self.hbox3.pack_start(bottom_hex_label, expand=False)
            self.hbox3.pack_start(spacer13)
