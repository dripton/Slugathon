...
class Proposal(Gtk.Dialog):
    ...
    def __init__(self, playername, attacker_legion, attacker_creature_names,
                 defender_legion, defender_creature_names, def1, parent):
        GObject.GObject.__init__(self, title="Proposal - %s" % playername, parent=parent)
        ...
        attacker_marker_hbox.pack_start(attacker_marker.event_box, False, False, 0)
        ...
        defender_marker_hbox.pack_start(defender_marker.event_box, False, False, 0)
