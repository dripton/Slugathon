...
class User(Avatar):
    ...
    def perspective_concede(
        self, game_name, markerid, enemy_markerid, hexlabel
    ):
        self.server.concede(
    ...
    def perspective_no_more_proposals(
        self, game_name, attacker_markerid, defender_markerid
    ):
    ...
    def perspective_move_creature(
        self, game_name, creature_name, old_hexlabel, new_hexlabel
    ):
    ...
    def perspective_acquire_angels(self, game_name, markerid, angel_names):
